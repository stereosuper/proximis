...
var $ = __webpack_require__(/*! jquery-slim */ "./node_modules/jquery-slim/dist/jquery.slim.js");

var win = __webpack_require__(/*! ./Window */ "./wp-content/themes/proximis/src/js/Window.js");

var requestAnimFrame = __webpack_require__(/*! ./requestAnimFrame.js */ "./wp-content/themes/proximis/src/js/requestAnimFrame.js");

var throttle = __webpack_require__(/*! ./throttle.js */ "./wp-content/themes/proximis/src/js/throttle.js");

var Scroll = function ScrollClass() {
  var _this = this;
  ...
  this.scrollHandler = function () {
    _this.scrollTop = $(window).scrollTop() || window.scrollY;
    clearTimeout(_this.timeout);
    _this.timeout = setTimeout(function () {
      _this.onScrollEnd();
    }, 66);

    _this.scrollFunctions.forEach(function (f) {
      f();
    });
  };

  this.addScrollFunction = function (f) {
    var onEnd = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;

    _this.scrollFunctions.push(f);

    if (onEnd) _this.endFunctions.push(f);
  };

  this.addEndFunction = function (f) {
    _this.endFunctions.push(f);
  };
  ...
  this.init = function () {
    ...
    $(window).on('scroll', throttle(function (e) {
      _this.event = e;
      requestAnimFrame(_this.scrollHandler);
    }));
  };

  this.onScrollEnd = function () {
    _this.endFunctions.forEach(function (f) {
      f();
    });
  };
};
...
/***/ "./wp-content/themes/proximis/src/js/Snif.js":
/*!***************************************************!*\
  !*** ./wp-content/themes/proximis/src/js/Snif.js ***!
  \***************************************************/
/*! no static exports found */
...
/***/ "./wp-content/themes/proximis/src/js/Window.js":
/*!*****************************************************!*\
  !*** ./wp-content/themes/proximis/src/js/Window.js ***!
  \*****************************************************/
/*! no static exports found */
...
var io = __webpack_require__(/*! ./io.js */ "./wp-content/themes/proximis/src/js/io.js");
...
var app = function Window() {
  ...
  this.resizeend = function () {
    if (new Date() - rtime < delta) {
      setTimeout(_this.resizeend, delta);
    } else {
      timeout = false;

      _this.noTransitionElts.removeClass('no-transition');
    }
  };

  this.noTransition = function () {
    _this.noTransitionElts.addClass('no-transition');
  ...
  this.resizeHandler = function () {
    ...
    _this.resizeFunctions.forEach(function (f) {
      f();
    });
  };

  this.addResizeFunction = function (f) {
    _this.resizeFunctions.push(f);
  };

  this.init = function () {
    _this.resizeFunctions = [_this.noTransition, _this.ioResize];
    $(window).on('resize', throttle(function () {
      requestAnimFrame(_this.resizeHandler);
    }, 60));
  };
};
...
/***/ "./wp-content/themes/proximis/src/js/fallback.js":
/*!*******************************************************!*\
  !*** ./wp-content/themes/proximis/src/js/fallback.js ***!
  \*******************************************************/
...
var snif = __webpack_require__(/*! ./Snif */ "./wp-content/themes/proximis/src/js/Snif.js");

var init = function init(body, html) {
...
/***/ "./wp-content/themes/proximis/src/js/io.js":
/*!*************************************************!*\
  !*** ./wp-content/themes/proximis/src/js/io.js ***!
  \*************************************************/
/*! exports provided: default */
...
var io = function io() {
  ...
  this.init = function () {
    ...
    objectsToIO.forEach(function (obj) {
...
/* harmony import */ var _Window_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Window.js */ "./wp-content/themes/proximis/src/js/Window.js");
/* harmony import */ var _Window_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_Window_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _io_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./io.js */ "./wp-content/themes/proximis/src/js/io.js");
/* harmony import */ var _Scroll_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Scroll.js */ "./wp-content/themes/proximis/src/js/Scroll.js");
...
/* harmony import */ var _fallback_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./fallback.js */ "./wp-content/themes/proximis/src/js/fallback.js");
/* harmony import */ var jquery_slim__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! jquery-slim */ "./node_modules/jquery-slim/dist/jquery.slim.js");
/* harmony import */ var jquery_slim__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(jquery_slim__WEBPACK_IMPORTED_MODULE_6__);
...
var html = jquery_slim__WEBPACK_IMPORTED_MODULE_6___default()('html');
var body = jquery_slim__WEBPACK_IMPORTED_MODULE_6___default()('body');

var loadHandler = function loadHandler() {
  _Scroll_js__WEBPACK_IMPORTED_MODULE_4___default.a.init();
  _Window_js__WEBPACK_IMPORTED_MODULE_2___default.a.noTransitionElts = jquery_slim__WEBPACK_IMPORTED_MODULE_6___default()('.element-without-transition-on-resize');
  _Window_js__WEBPACK_IMPORTED_MODULE_2___default.a.init();
  _io_js__WEBPACK_IMPORTED_MODULE_3__["default"].init();
  Object(_fallback_js__WEBPACK_IMPORTED_MODULE_5__["default"])(body, html);
};

if (document.readyState === 'complete') {
  loadHandler();
} else {
  jquery_slim__WEBPACK_IMPORTED_MODULE_6___default()(window).on('load', loadHandler);
}
...
/***/ "./wp-content/themes/proximis/src/js/throttle.js":
/*!*******************************************************!*\
  !*** ./wp-content/themes/proximis/src/js/throttle.js ***!
  \*******************************************************/
/*! no static exports found */
